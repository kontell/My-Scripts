...
## grab-epg.sh
This uses the iptv-org [epg]([https://www.google.com](https://github.com/iptv-org/epg/)) project to grab multiple epgs, merge them into a single file and trim old data.
